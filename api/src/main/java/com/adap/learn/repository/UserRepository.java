 ...
 */
@Repository
public interface UserRepository extends JpaRepository<ParentEntity, Long> {
     ...
     */
    @Query("SELECT u FROM ParentEntity u WHERE u.active = true")
    java.util.List<ParentEntity> findAllVerifiedUsers();
}
